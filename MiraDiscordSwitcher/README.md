...
- Multiple Discord sessions in one window.
...
- Network access to Discord is required.
...
Report bugs or suggestions through the repository's issue templates:

https://github.com/morteva/mira-utilities/issues/new/choose

When attaching screenshots, remove passwords, account details, tokens, private server information, and other sensitive content first.
