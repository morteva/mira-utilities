...
- Added tab-based account switching without logging in and out.
- Added **+ Add**, **Reload**, **Rename**, and **Remove** session controls.
- Added Windows taskbar notification badge counts reported by Discord.
- Preserved normal Discord functionality inside each session.
